...
public class SwipeLayout extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private static final int ITEM_STATE_LEFT_EXPAND = 0;
    private static final int ITEM_STATE_RIGHT_EXPAND = 1;
    ...
    private final Animation.AnimationListener collapseListener = new Animation.AnimationListener() {
        @Override
    ...
    private boolean inAnimatedState() {
        if (leftLinear != null) {
    ...
    private void setAutoHideSwipe(boolean autoHideSwipe) {
    ...
    private void setOnlyOneSwipe(boolean onlyOneSwipe) {
        this.onlyOneSwipe = onlyOneSwipe;
    }

    private boolean isLeftExpanding() {
        return ViewCompat.getTranslationX(mainLayout) > 0;
    }

    private boolean isRightExpanding() {
        return ViewCompat.getTranslationX(mainLayout) < 0;
    }
