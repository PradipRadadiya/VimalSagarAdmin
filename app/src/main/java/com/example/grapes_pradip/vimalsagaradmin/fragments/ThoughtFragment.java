...
import com.example.grapes_pradip.vimalsagaradmin.adapters.thought.RecyclerThoughtAdapter;
...
import static com.example.grapes_pradip.vimalsagaradmin.adapters.thought.RecyclerThoughtAdapter.thoughtid;
...
public class ThoughtFragment extends Fragment implements View.OnClickListener {
    ...
    private RecyclerView recyclerView_thought;
    private LinearLayoutManager linearLayoutManager;
    private ArrayList<AllThoughtItem> allThoughtItemArrayList = new ArrayList<>();
    private RecyclerThoughtAdapter recyclerThoughtAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootview = inflater.inflate(R.layout.thought_fragment, container, false);
       ...
       /* recyclerView_thought.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                                     @Override
    ...
    private void refreshContent() {
        page_count = 1;
        thoughtid.clear();
        allThoughtItemArrayList = new ArrayList<>();
        swipe_refresh.setRefreshing(false);
        new GetAllThought().execute();
    }
    ...
    private void findID() {
        ...
        recyclerView_thought = (RecyclerView) rootview.findViewById(R.id.recyclerView_thought);
        recyclerView_thought.setLayoutManager(linearLayoutManager);
...
//                            Toast.makeText(activity, "You clicked on NO", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(getActivity(), "Select thought for delete.", Toast.LENGTH_SHORT).show();
                }
...
//            progressDialog.setCancelable(false);
            ...
            recyclerView_thought.setVisibility(View.GONE);
        }

        @Override
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.getallthoughts + "?page=" + page_count + "&psize=1000");
            return responseJSON;
        }
...
//            }
            ...
            recyclerView_thought.setVisibility(View.VISIBLE);
            if (recyclerView_thought != null) {
                recyclerThoughtAdapter = new RecyclerThoughtAdapter(getActivity(), allThoughtItemArrayList);
                if (recyclerThoughtAdapter.getItemCount() != 0) {
                    recyclerView_thought.setVisibility(View.VISIBLE);
                    img_nodata.setVisibility(View.GONE);
                    recyclerView_thought.setAdapter(recyclerThoughtAdapter);
                } else {
                    recyclerView_thought.setVisibility(View.GONE);
...
//            progressDialog.setCancelable(false);
        ...
        @Override
        protected String doInBackground(String... params) {
            for (int i = 0; i < thoughtid.size(); i++) {
                String value = thoughtid.get(i);
                responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.deletethought + "?tid=" + value);
            }
            return responseJSON;
        }
