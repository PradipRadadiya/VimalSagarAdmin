...
public class RecyclerAudioCommentAdapter extends RecyclerView.Adapter<RecyclerAudioCommentAdapter.ViewHolder> {
    ...
    public RecyclerAudioCommentAdapter(Activity activity, ArrayList<CommentList> itemArrayList) {
        super();
...
//            Toast.makeText(activity, "long Click" + getAdapterPosition(), Toast.LENGTH_SHORT).show();
    ...
    private class ApprovePost extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.approvecommentaudio + "?commentid=" + id);
            return responseJSON;
        }
    ...
    private class RejectPost extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.rejectcommentaudio + "?commentid=" + id);
            return responseJSON;
        }
