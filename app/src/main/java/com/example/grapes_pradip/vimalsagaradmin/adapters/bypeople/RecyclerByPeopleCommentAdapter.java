...
public class RecyclerByPeopleCommentAdapter extends RecyclerView.Adapter<RecyclerByPeopleCommentAdapter.ViewHolder> {
    ...
    public RecyclerByPeopleCommentAdapter(Activity activity, ArrayList<CommentList> itemArrayList) {
        super();
...
//            Toast.makeText(activity, "long Click" + getAdapterPosition(), Toast.LENGTH_SHORT).show();
    ...
    private class ApprovePost extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.approvecommentbypeople + "?commentid=" + id);
            return responseJSON;
        }
    ...
    private class RejectPost extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.rejectcommentbypeople + "?commentid=" + id);
            return responseJSON;
        }
...
//                    notifyDataSetChanged();
                    ...
                    Toast.makeText(activity, "Coment not reject." , Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
