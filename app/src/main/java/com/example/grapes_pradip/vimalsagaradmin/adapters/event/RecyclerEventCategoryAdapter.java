...
import com.example.grapes_pradip.vimalsagaradmin.activities.event.AllEventFragment;
import com.example.grapes_pradip.vimalsagaradmin.activities.event.EditEventCategoryActivity;
...
public class RecyclerEventCategoryAdapter extends RecyclerView.Adapter<RecyclerEventCategoryAdapter.ViewHolder> {
    ...
    public RecyclerEventCategoryAdapter(Activity activity, ArrayList<AllAudioCategoryItem> itemArrayList) {
        super();
    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        ...
        String path = CommonURL.ImagePath + CommonAPI_Name.eventcategory + audioCategoryItem.getCategoryicon().replaceAll(" ", "%20");
...
//            Picasso.with(activity).load(path).error(R.drawable.noimageavailable).placeholder(R.drawable.loading_bar).resize(0,200).into(holder.img_audio_category);
        ...
        holder.txt_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity, EditEventCategoryActivity.class);
...
//            Toast.makeText(activity, "on Click" + getAdapterPosition(), Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(v.getContext(), AllEventFragment.class);
...
//                    Toast.makeText(itemView.getContext(), "Trash" + id, Toast.LENGTH_SHORT).show();
    ...
    private class DeleteEventCategory extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = JsonParser.postStringResponse(CommonURL.Main_url + CommonAPI_Name.eventdeletecategory,nameValuePairs,activity);
//            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.eventdeletecategory + "?cid=" + id);
            return responseJSON;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                    ...
                    Toast.makeText(activity, "Event category not delete.", Toast.LENGTH_SHORT).show();
                }
