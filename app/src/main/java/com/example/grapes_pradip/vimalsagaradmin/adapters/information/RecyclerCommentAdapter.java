...
public class RecyclerCommentAdapter extends RecyclerView.Adapter<RecyclerCommentAdapter.ViewHolder> {
    ...
    public RecyclerCommentAdapter(Activity activity, ArrayList<CommentList> itemArrayList) {
        super();
...
//            Toast.makeText(activity, "long Click" + getAdapterPosition(), Toast.LENGTH_SHORT).show();
    ...
    private class ApprovePost extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.approvecomment + "?commentid=" + id);
            return responseJSON;
        }
