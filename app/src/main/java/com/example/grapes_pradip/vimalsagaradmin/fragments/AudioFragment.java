...
import com.example.grapes_pradip.vimalsagaradmin.adapters.audio.RecyclerAudioCategoryAdapter;
...
public class AudioFragment extends Fragment implements View.OnClickListener {
    ...
    private RecyclerAudioCategoryAdapter recyclerAudioCategoryAdapter;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.txt_addnew:
                Intent intent = new Intent(getActivity(), AddAudioCategoryActivity.class);
...
//            progressDialog.setCancelable(false);
        ...
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.getAudioAllcategory);
            return responseJSON;
        }
...
//            }
            ...
            if (recyclerView_audio_category != null) {
                recyclerAudioCategoryAdapter = new RecyclerAudioCategoryAdapter(getActivity(), allAudioCategoryItems);
...
//            progressDialog.setCancelable(false);
        ...
        protected String doInBackground(String... params) {
            for (int i = 0; i < audio_cat.size(); i++) {
                ...
                responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.deletecategory + "?cid=" + value);
            }
            return responseJSON;
        }
