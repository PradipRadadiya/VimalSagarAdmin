...
import com.example.grapes_pradip.vimalsagaradmin.activities.jainism.AddJainism;
import com.example.grapes_pradip.vimalsagaradmin.activities.note.AddNote;
import com.example.grapes_pradip.vimalsagaradmin.adapters.jainism.RecyclerJainismAdapter;
...
public class JainismFragment extends Fragment {
    private View rootview;
    private SwipeRefreshLayout swipe_refresh;
    private RecyclerView recyclerView_users;
    private LinearLayoutManager linearLayoutManager;
    private ArrayList<JainismItem> usersItems = new ArrayList<>();
    private RecyclerJainismAdapter recyclerJainismAdapter;
    //page count
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootview = inflater.inflate(R.layout.fragment_jainism, container, false);
...
//        linearLayoutManager=new LinearLayoutManager(getActivity());
        ...
        recyclerJainismAdapter = new RecyclerJainismAdapter(getActivity(), usersItems);
        recyclerView_users.setAdapter(recyclerJainismAdapter);
...
//        usersItems = new ArrayList<>();
        ...
        txt_addnew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), AddJainism.class);
...
//            recyclerView_users.setVisibility(View.GONE);
        ...
        protected String doInBackground(String... params) {
            ...
            responseJSON = JsonParser.postStringResponse(CommonURL.Main_url + "jainaism/display", nameValuePairs, getActivity());
            return responseJSON;
        }
...
//                        String time = jsonObject1.getString("time");
                        usersItems.add(new JainismItem(id, title, description, date, "",audio,total_likes,total_comments,total_views));
