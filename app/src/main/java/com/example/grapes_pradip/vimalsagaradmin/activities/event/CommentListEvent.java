...
public class CommentListEvent extends AppCompatActivity {
        ...
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(CommentListEvent.this)) {
                        new AdminComment().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(CommentListEvent.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CommentListEvent.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                recyclerCommentAdapter = new RecyclerEventCommentAdapter(CommentListEvent.this, commentLists);
    ...
    private class AdminComment extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("eid", aid));
                nameValuePairs.add(new BasicNameValuePair("Comment", params[0]));
                responseJSON = JsonParser.postStringResponse(CommonURL.Main_url + CommonAPI_Name.admincommentevent, nameValuePairs, CommentListEvent.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                    if (CommonMethod.isInternetConnected(CommentListEvent.this)) {
                        ...
                        new CommentList().execute();
                        Toast.makeText(CommentListEvent.this, "Comment added successfully.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        edit_comment.setText("");
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(CommentListEvent.this, "Comment not added.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                }
            } catch (JSONException e) {
