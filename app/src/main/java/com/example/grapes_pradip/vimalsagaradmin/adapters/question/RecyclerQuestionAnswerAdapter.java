    ...
    public void onBindViewHolder(final ViewHolder holder, int i) {
        ...
        holder.txt_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("isApprove", itemArrayList.get(holder.getAdapterPosition()).getIsApproved());
                intent.putExtra("userid", itemArrayList.get(holder.getAdapterPosition()).getUserID());
