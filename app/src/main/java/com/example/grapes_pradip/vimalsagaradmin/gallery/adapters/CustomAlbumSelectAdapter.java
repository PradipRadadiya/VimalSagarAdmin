...
import com.example.grapes_pradip.vimalsagaradmin.gallery.models.Album;
...
public class CustomAlbumSelectAdapter extends CustomGenericAdapter<Album> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.drawable.image_placeholder).centerCrop().dontAnimate().into(viewHolder.imageView);
