...
import com.example.grapes_pradip.vimalsagaradmin.activities.event.AddEventActivity;
...
public class EventFragment extends Fragment implements View.OnClickListener {
    ...
    private void findID() {
        ...
        recyclerView_event = (RecyclerView) rootview.findViewById(R.id.recyclerView_event);
...
//            }
            ...
            if (recyclerView_event != null) {
                recyclerEventAdapter = new RecyclerEventAdapter(getActivity(), allIEventItems);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(getActivity(), "Event not deleted.", Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
