...
public class RecyclerVideoCommentAdapter extends RecyclerView.Adapter<RecyclerVideoCommentAdapter.ViewHolder> {
    ...
    public RecyclerVideoCommentAdapter(Activity activity, ArrayList<CommentList> itemArrayList) {
        super();
...
//            Toast.makeText(activity, "long Click" + getAdapterPosition(), Toast.LENGTH_SHORT).show();
    ...
    private class ApprovePost extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.approvecommentvideo + "?commentid=" + id);
            return responseJSON;
        }
    ...
    private class RejectPost extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.rejectcommentvideo + "?commentid=" + id);
            return responseJSON;
        }
...
//                    notifyDataSetChanged();
                    ...
                    Toast.makeText(activity, "Comment not reject." , Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
