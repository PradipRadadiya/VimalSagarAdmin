...
public class CommentListAudio extends AppCompatActivity {
        ...
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(CommentListAudio.this)) {
                        new AdminComment().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(CommentListAudio.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CommentListAudio.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                recyclerCommentAdapter = new RecyclerAudioCommentAdapter(CommentListAudio.this, commentLists);
    ...
    private class AdminComment extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                responseJSON = JsonParser.postStringResponse(CommonURL.Main_url + CommonAPI_Name.admincommentaudio, nameValuePairs, CommentListAudio.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                    if (CommonMethod.isInternetConnected(CommentListAudio.this)) {
                        ...
                        new CommentList().execute();
                        Toast.makeText(CommentListAudio.this, "Comment added successfully.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        edit_comment.setText("");
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(CommentListAudio.this, "Comment not added.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                }
            } catch (JSONException e) {
