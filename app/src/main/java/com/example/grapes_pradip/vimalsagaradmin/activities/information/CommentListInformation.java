...
public class CommentListInformation extends AppCompatActivity {
        ...
        img_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(CommentListInformation.this)) {
                        new AdminComment().execute(edit_comment.getText().toString());
                    } else {
                        Toast.makeText(CommentListInformation.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CommentListInformation.this);
        ...
        protected String doInBackground(String... params) {
            responseJSON = JsonParser.getStringResponse(CommonURL.Main_url + CommonAPI_Name.getallcomments + "?infoid=" + aid + "&page=" + page_count + "&psize=1000");
            return responseJSON;
        }
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                recyclerCommentAdapter = new RecyclerCommentAdapter(CommentListInformation.this, commentLists);
    ...
    private class AdminComment extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("infoid", aid));
                nameValuePairs.add(new BasicNameValuePair("Comment", params[0]));
                responseJSON = JsonParser.postStringResponse(CommonURL.Main_url + CommonAPI_Name.admincomment, nameValuePairs, CommentListInformation.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("success")) {
                    if (CommonMethod.isInternetConnected(CommentListInformation.this)) {
                        ...
                        new CommentList().execute();
                        Toast.makeText(CommentListInformation.this, "Comment added successfully.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        edit_comment.setText("");
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(CommentListInformation.this, "Comment not added.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                }
            } catch (JSONException e) {
