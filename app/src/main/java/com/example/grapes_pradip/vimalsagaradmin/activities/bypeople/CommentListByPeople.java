...
public class CommentListByPeople extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(edit_comment.getText().toString())) {
                    ...
                    if (CommonMethod.isInternetConnected(CommentListByPeople.this)) {
                        ...
                        Toast.makeText(CommentListByPeople.this, R.string.internet, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private class CommentList extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CommentListByPeople.this);
        ...
        protected void onPostExecute(String s) {
            ...
            if (recyclerView_comments != null) {
                recyclerCommentAdapter = new RecyclerByPeopleCommentAdapter(CommentListByPeople.this, commentLists);
    ...
    private class AdminComment extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                responseJSON = JsonParser.postStringResponse(CommonURL.Main_url + CommonAPI_Name.admincommentbypeople, nameValuePairs, CommentListByPeople.this);
            } catch (Exception e) {
                e.printStackTrace();
            }
            return responseJSON;
...
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(CommentListByPeople.this, "Comment not added.", Toast.LENGTH_SHORT).show();
//                        Toast.makeText(AudioDetailActivity.this, "" + jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
                }
            } catch (JSONException e) {
